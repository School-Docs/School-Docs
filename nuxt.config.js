...
export default {
  ...
  head: {
    titleTemplate: '%s - School-Machine Docs',
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no' },
      { hid: 'description', name: 'description', content: 'School-Machine 의 공식 문서입니다.' }
    ],
    link: [
  ...
  pwa: {
    ...
    manifest: {
      name: 'School-Machine Documents',
      short_name: "Docs",
      description: 'School-Machine 의 공식 문서를 지금 확인해보세요.',
      lang: 'ko',
